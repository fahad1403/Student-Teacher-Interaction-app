...
render(){
      ...
      <Button title="लॉग इन करें" color="#008a7a" onPress={()=> this.props.navigation.navigate('HomeVideoHindi')}/>
      <br/>
     <TouchableOpacity onPress={()=> this.props.navigation.navigate('RegisterHindi')}>
        <Text>नया सदस्य?</Text>
      </TouchableOpacity>
